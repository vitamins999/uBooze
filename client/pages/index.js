              ...
              <div className='flex rounded-lg h-full bg-gray-100 p-8 flex-col shadow-md'>
                ...
                <div className='flex-grow'>
                  <p className='leading-relaxed text-base text-gray-700'>
                    Simply type your postcode in and select the mile radius, and
                    we'll find the supermarkets near you and their prices.
                  </p>
              ...
              <div className='flex rounded-lg h-full bg-gray-100 p-8 flex-col shadow-md'>
                ...
                <div className='flex-grow'>
                  <p className='leading-relaxed text-base text-gray-700'>
                    ...
                    manually what supermarkets you want to compare.
                  </p>
