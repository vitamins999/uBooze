...
const BrandyCognacPage = ({ drinks }) => {
  ...
  const { resolvedData, latestData, status } = usePaginatedQuery(
    ['brandycognac', page, queryString, order, limit],
    fetchDrinksSub,
    {
      initialData: drinks,
    }
      ...
      {status === 'success' && (
        <main className='flex flex-col mb-40'>
          ...
          <div className='pb-10 px-5 container mx-auto'>
            <CategoryBar primary='spirits' secondary='brandy' title={title} />
            <div>
              <ProductResults
...
export default BrandyCognacPage;
