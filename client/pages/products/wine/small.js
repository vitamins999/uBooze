...
const SmallWinePage = ({ drinks }) => {
  ...
  const queryString = Cookies.get('queryString') + '&subtype=small';
...
export const getServerSideProps = async ({ req }) => {
  try {
    ...
    const queryStringData = cookies.queryString + '&subtype=small';
