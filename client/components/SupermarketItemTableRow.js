<li className='list-none p-4 bg-white rounded-lg shadow-md border border-gray-400 relative hover:shadow-xl transform hover:scale-105 transition ease-in-out duration-200'>
  <div>
