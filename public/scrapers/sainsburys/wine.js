...
exports.sainsburysScrapeWine = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // Champagne and Sparkling
    const wineChampagneSparkling = yield sainsburysScraper_1.sainsburysScraper(wineChampagneSparklingURL);
    // Boxes
    const wineBoxes = yield sainsburysScraper_1.sainsburysScraper(wineBoxesURL);
    // Fortified and vermouth
    const wineFortifiedVermouth = yield sainsburysScraper_1.sainsburysScraper(wineFortifiedVermouthURL);
    // Small
    const wineSmall = yield sainsburysScraper_1.sainsburysScraper(wineSmallURL);
    // Low alcohol
